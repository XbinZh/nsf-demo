package com.ccb.cloud.alioth.demo.stock.provider.web.controller;
...
public class StockController {
	...
	public String echo(HttpServletRequest request) {
		...
		String host = request.getServerName();
		int port = request.getServerPort();
		String color = request.getHeader("x-color-trace");

		return "echo from " + name + " " + version +"[" + host + ":" + port + "]" + System.lineSeparator() + " x-color-trace:" + color;
	}
